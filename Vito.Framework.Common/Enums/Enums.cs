...
public enum ActionTypeEnum
{
    ...
    ActionType_LoginFail_ApplicationNoFound = 20,
    ActionType_LoginFail_ApplicationSecretInvalid = 21,
    ActionType_LoginFail_UserNotFound = 22,
    ActionType_LoginFail_UserSecretInvalid = 23,
    ActionType_LoginSuccessByAuthorizationCode = 24,
    ActionType_LoginSuccessByClientCredentials = 25,
    ActionType_ChangeUserPassword = 26,
    ActionType_Logoff = 27,
}
